...
def test_create(client):
    request = respx.post(f"{API_BASE_URL}/v1/groups/persons/").respond(
        status_code=201,
...
def test_get_200(client):
    request = respx.get(f"{API_BASE_URL}/v1/groups/persons/1/").respond(
        status_code=200,
        json={"id": 1, "name": "test"},
    )
...
def test_update_200(client):
    request = respx.patch(f"{API_BASE_URL}/v1/groups/persons/1/").respond(
        status_code=200,
...
def test_delete_204(client):
    request = respx.delete(f"{API_BASE_URL}/v1/groups/persons/1/").respond(
        status_code=204
    )
...
def test_add_persons_200(client):
    request = respx.post(f"{API_BASE_URL}/v1/groups/persons/pids/").respond(
        status_code=200
    )
...
def test_remove_persons_200(client):
    request = respx.delete(f"{API_BASE_URL}/v1/groups/persons/pids/").respond(
        status_code=200
    )
