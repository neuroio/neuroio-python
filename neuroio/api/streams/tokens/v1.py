...
class StreamTokens(APIBase):
    def create(self, permanent: bool = False) -> Response:
        data = {"permanent": permanent}

        with self.get_client() as client:
            return client.post(url="/v1/streams/tokens/", json=data)
    ...
    def list(
        ...
        with self.get_client() as client:
            return client.get(url="/v1/streams/tokens/", params=data)

    def get(self, token_id_or_key: Union[int, str]) -> Response:
        with self.get_client() as client:
            return client.get(url=f"/v1/streams/tokens/{token_id_or_key}/")
    ...
    def update(
        ...
        with self.get_client() as client:
            return client.patch(
                url=f"/v1/streams/tokens/{token_id_or_key}/",
    ...
    def delete_list(self, permanent: bool = None) -> Response:
        ...
        with self.get_client() as client:
            return client.delete(url="/v1/streams/tokens/", params=data)

    def delete(self, token_id_or_key: Union[int, str]) -> Response:
        with self.get_client() as client:
            return client.delete(url=f"/v1/streams/tokens/{token_id_or_key}/")


class StreamTokensAsync(APIBaseAsync):
    async def create(self, permanent: bool = False) -> Response:
        data = {"permanent": permanent}

        async with self.get_client() as client:
            return await client.post(url="/v1/streams/tokens/", json=data)
    ...
    async def list(
        ...
        async with self.get_client() as client:
            return await client.get(url="/v1/streams/tokens/", params=data)
    ...
    async def delete_list(self, permanent: bool = None) -> Response:
        ...
        async with self.get_client() as client:
            return await client.delete(url="/v1/streams/tokens/", params=data)
